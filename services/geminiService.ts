...
export const generateImageFromText = async (prompt: string): Promise<string> => {
    ...
    try {
        ...
        throw new Error("No image was generated by the API. The response may have been blocked or empty.");
        ...
        throw new Error("Failed to generate image from text. Please try again later.");
    }
};